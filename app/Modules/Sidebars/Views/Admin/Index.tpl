...
    <div class="box-body">
		...
		<p><a href='<?=admin_url('sidebars/create');?>' class='btn btn-info btn-xs'><i class='fa fa-plus'></i> Create Sidebar</a></p>
                ...
                if (! $leftSidebars->isEmpty()) {
                    foreach($leftSidebars as $row) {
                        echo "<tr>";
                            ...
                            <a href='".admin_url('sidebars/'.$row->id.'/edit')."' class='btn btn-warning btn-xs'><i class='fa fa-edit'></i> Edit</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="<?= admin_url('sidebars/' .$sidebar->id .'/destroy'); ?>" method="POST">
