...
<div class="content">
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">Link to Office 365</h3>
            <div class="box-tools pull-right">
                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
            </div>
        ...
        <div class="box-body">
            ...
            <h5>This will allow modules to add events to your calendar, integrate your emails.</h5>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="control-group">
                        ...
                        <input class="form-control" id='office365Email' type="text" name="office365Email" value="<?=Input::old('office365Email', $user->office365Email);?>" />
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="control-group colorpicker">
                        ...
                        <input class="form-control" id='backgroundColour' type="text" name="backgroundColour" value="<?=Input::old('backgroundColour', $user->backgroundColour);?>" />
                ...
                <div class="col-md-6">
                    ...
                    <div class="control-group colorpicker">
                        ...
                        <input class="form-control" id='textColor' type="text" name="textColor" value="<?=Input::old('textColor', $user->textColor);?>" />
                        <span class="input-group-addon"></span>
                    </div>
