...
        <li><a href='<?php echo admin_url('menus'); ?>'><i class="fa fa-book"></i> Menus</a></li>
        <li>Manage Menu: <?php echo e($menu->title); ?></li>
    </ol>
</section>
                            ...
                            <div id="collapseOne" class="panel-collapse collapse in">
                              <div class="panel-body">
                                ...
                                <?php foreach($pages as $page): ?>
                                    <label><input type='checkbox' name='page[]' value='<?php echo e(Config::get('app.path').$page->slug); ?>' data-title='<?php echo e($page->pageTitle); ?>' data-id='<?php echo e($page->id); ?>' class='checkbox1' /> <?php echo e($page->pageTitle); ?></label><br>
                                <?php endforeach; ?>
